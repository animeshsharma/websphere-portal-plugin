...
import com.googlecode.websphere.AbstractXMLAccessMojo;
...
public class XMLAccessNameValuePairs {
	...
	public static Map<Object, Object> asMap(AbstractXMLAccessMojo mojo) {
		...
		nameValuePairs
				.put(FTL_VAL_WPS_CONFIG_URL, mojo.getWas().getConfigURL());
		nameValuePairs.put(FTL_VAL_WPS_CONFIG_USERNAME, mojo.getWas()
				.getWpsUsername());
		nameValuePairs.put(FTL_VAL_WPS_CONFIG_PASSWORD, mojo.getWas()
				.getWpsPassword());
